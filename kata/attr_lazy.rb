# From https://www.codewars.com/kata/attrlazy-lazy-values-made-simple
# Description:
...
#   end
# end
# There is one more thing. We want to make sure that we have access to the instance variable so that we can set it manually, either before the method is called or anytime after. Therefor the block passed in to attr_lazy should only be called, and its value applied to the variable, if the variable is nil.
